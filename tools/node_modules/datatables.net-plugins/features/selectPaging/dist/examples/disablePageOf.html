...
<head>
	...
	<title>SelectPaging example - Disable "page of"</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>SelectPaging example <span>Disable "page of"</span></h1>
			<div class="info">
				<p>This example shows the select paging control with the <code>pageOf</code> option disabled, so the <code class="tag" title="HTML tag">select</code> element is
				not followed by the total number of pages in the DataTable.</p>
			</div>
			<div class="demo-html">
