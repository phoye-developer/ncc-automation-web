...
<head>
	...
	<title>SelectPaging example - Basic example</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>SelectPaging example <span>Basic example</span></h1>
			<div class="info">
				<p>This example demonstrates the select paging control, which can be used in place of (or alongside if you really wanted!) the built in <a href=
				"//datatables.net/reference/feature/paging"><code class="feature" title="DataTables feature type">paging</code></a> control. It provides a <code class="tag" title=
				"HTML tag">select</code> element that is used to show the current page and allow the end user to select from the dropdown the page number they want to view.</p>
			</div>
			<div class="demo-html">
				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li>
								<a href="./disablePageOf.html">Disable "page of"</a>
							</li>
						</ul>
					</div>
				</div>
