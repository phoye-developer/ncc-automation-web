...
<head>
	...
	<title>DataTables examples - SelectPaging feature plugin</title>
</head>
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>SelectPaging feature plugin</span></h1>
			<div class="info">
				<p>The SelectPaging plugin for DataTables which adds a <em>feature</em> to DataTables for use in the <a href=
				"//datatables.net/reference/option/layout"><code class="option" title="DataTables initialisation option">layout</code></a> option. The <code>selectPaging</code>
				feature provides the ability to show a paging control with an <code class="tag" title="HTML tag">select</code> element that will show the current page and also
				allow the end user to select from the dropdown the page number they want to view.</p>
			</div>
		</section>
	</div>
	<section>
