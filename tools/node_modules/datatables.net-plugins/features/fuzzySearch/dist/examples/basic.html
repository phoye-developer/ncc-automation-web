...
<head>
	...
	<title>FuzzySearch example - Basic example</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>FuzzySearch example <span>Basic example</span></h1>
			<div class="info">
				<p>This example demonstrates the fuzzy search input control, which allows the end user to fuzzy match on data in a table.</p>
			</div>
			<div class="demo-html">
