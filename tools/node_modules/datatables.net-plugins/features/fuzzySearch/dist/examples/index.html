...
<head>
	...
	<title>DataTables examples - FuzzySearch feature plugin</title>
</head>
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>FuzzySearch feature plugin</span></h1>
			<div class="info">
				<p>The FuzzySearch plugin for DataTables which adds a <em>feature</em> to DataTables for use in the <a href="//datatables.net/reference/option/layout"><code class=
				"option" title="DataTables initialisation option">layout</code></a> option. The <code>fuzzySearch</code> feature provides an input control that will give the end
				user of fuzzy matching on the text in the table.</p>
			</div>
		</section>
	</div>
	<section>
